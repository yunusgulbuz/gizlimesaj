...
export const BASE_TEMPLATES: BaseTemplate[] = [
  {
    ...
    thumbnail: '/template-thumbnails/romantic-letter.jpg',
...

  {
    ...
    thumbnail: '/template-thumbnails/glass-modern.jpg',
...

  {
    ...
    thumbnail: '/template-thumbnails/professional-frame.jpg',
...

  {
    ...
    thumbnail: '/template-thumbnails/gradient-celebration.jpg',
...

  {
    ...
    thumbnail: '/template-thumbnails/elegant-classic.jpg',
...

  {
    ...
    thumbnail: '/template-thumbnails/minimalist-modern.jpg',
...

  {
    ...
    thumbnail: '/template-thumbnails/playful-fun.jpg',
