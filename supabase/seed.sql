...
('seni-seviyorum-premium', 'Seni Seviyorum Premium', 'adult', null, null, true),
...
('evlilik-teklifi-elegant', 'Benimle Evlenir misin?', 'elegant', '/templates/elegant-proposal.jpg', null, true),
('dogum-gunu-fun', 'Doğum Günün Kutlu Olsun', 'fun', '/templates/fun-birthday.jpg', null, true),
...
('mutlu-yillar-fun', 'Mutlu Yıllar', 'fun', '/templates/fun-newyear.jpg', null, true),
('romantik-mesaj-elegant', 'Romantik Mesaj', 'elegant', '/templates/elegant-romantic.jpg', null, true);
