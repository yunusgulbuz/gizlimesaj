      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-2">
            <Skeleton className="h-8 w-56" variant="shimmer" />
            ...
            <div className="flex items-start justify-between">
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <Skeleton className="h-5 w-24 rounded-full" variant="gradient" />
                </div>
                <div className="space-y-1">
                  <Skeleton className="h-4 w-64" variant="pulse" />
                  <Skeleton className="h-4 w-48" variant="pulse" />
                </div>
              </div>
      ...
      <div className="fixed bottom-8 right-8">
        <div className="bg-white/90 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg border border-pink-100">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm text-gray-600 font-medium">Talepler yükleniyor...</span>
          </div>
        </div>
      </div>
    </div>
